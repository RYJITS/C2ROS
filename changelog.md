...
- Application de la librairie d'icônes Phosphor dans toutes les applications.
- Ajout de `IconManager.applyIcons()` pour activer les icônes dans le contenu chargé dynamiquement.
